...
export function Expense() {
	...
	return (
		<>
			<NavBar/>
			<div className="relative max-w-full h-[56rem] ml-60 mt-10">
				{loading ? <Skeleton className="bg-white h-80 w-[72rem] rounded-2xl p-5 mb-10"/> :
					<div className="bg-white h-80 w-[72rem] rounded-2xl p-5">
						<h1 className="font-semibold uppercase text-2xl text-color1">Dépense</h1>
						...
						<label className="form-control w-full max-w-xs mr-10">
							...
							<select
								...
								<option value="Fournitures scolaire">Fournitures scolaire</option>
								<option value="Matérielles de travail">Matérielles de travail</option>
						...
						<button type="submit" onClick={handleAddExpense} className="btn bg-color1 text-white hover:bg-color3 border-none w-28 mt-9 ml-52">Ajouter</button>
					</div>
				</div>
				}
				{loading ? <Skeleton className="bg-white h-96 w-[72rem] rounded-2xl p-5 mb-10"/> :
				<div className="mt-10 bg-white overflow-auto h-96 w-[72rem] rounded-2xl p-5 mb-10">
					<div className="flex mb-10 items-center">
						<h2 className="text-color1 capitalize font-semibold">Liste de dépenses</h2>
						<input
