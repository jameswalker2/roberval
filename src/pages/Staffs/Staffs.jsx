...
export function Staffs() {
	...
	const handleDelete = async (staffId) => {
		try {
			...
			Modal.error({
				title: 'Erreur',
				content: 'Une erreur s\'est produite lors de la suppression du membre du personnel.'
			});
		}
	};
                        ...
                        <span className="flex justify-flex-start">
                           <div className="dropdown dropdown-end">
                              <div tabIndex={0} role="button"
                                   className={"btn btn-xs text-xs h-10 w-20 border-none text-white bg-primaryColor " + "hover:bg-slate-100 hover:text-primaryColor active:bg-slate-100"}>
                                Détails
                              </div>
                              <ul className="p-2 shadow menu dropdown-content z-[1] bg-white rounded-box w-32">
                                <li className="text-supportingColor4 hover:bg-slate-100 rounded-box mb-2">
																		<Button
																				...
																				className={"flex items-center bg-supportingColor4 text-white font-medium " +
                                ...
                                <li>
																	<Button
																			className={"flex items-center bg-supportingColor3 text-white font-medium" +
																					"border-none hover:bg-slate-100 active:bg-slate-100"}
