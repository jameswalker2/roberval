  ...
  // });
    ...
    <>
        <div className="relative w-full h-auto p-10">
            <NavLink className="text-3xl text-white absolute left-10 top-10" to={'/dashboard'}>
                <BiArrowBack id="back"/>
            </NavLink>
        ...
        {loading ? "" : (
          <form onSubmit={handleAdd} className="bg-white rounded w-full h-auto mt-20 p-4">
            <div className="bg-gray-50 p-5 rounded mt-2">
              ...
              <p className="mb-10">Les champs avec un astérisque <span className="text-red-600">*</span> sont obligatoires</p>
              <div className="flex flex-wrap justify-items-center ml-10">
                  <label className="form-control w-full max-w-xs mr-20 mb-10">
                      <div className="label">
                          <span className="label-text text-black">Nom <span className="text-red-600">*</span></span>
                      </div>
                      <input
                          onChange={(e) => setFirstName(e.target.value)}
                          type="text" placeholder="ex: Méat" className="input w-[22rem] bg-gray-200"/>
                      <div className="label">
                  ...
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Prénom <span className="text-red-600">*</span></span>
                      </div>
                      <input
                          onChange={(e) => setLastName(e.target.value)}
                          type="text" placeholder="ex: James" className="input w-[22rem] bg-gray-200 "/>
                      <div className="label">
                          <span className="label-text-alt"></span>
                      </div>
                  </label>
                  <label className="form-control w-full max-w-xs mr-20 mb-10">
                      <div className="label">
                          <span className="label-text text-black">Date de naissance <span className="text-red-600">*</span></span>
                      </div>
                      <input
                          onChange={(e) => setBirth(e.target.value)}
                          type="date" className="input w-[22rem] bg-gray-200 "/>
                      <div className="label">
                          <span className="label-text-alt"></span>
                      </div>
                  </label>
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Département de naissance <span className="text-red-600">*</span></span>
                      </div>
                      <input
                          onChange={(e) => setDepartmentBirth(e.target.value)}
                          type="text" placeholder="Département de naissance" className="input w-[22rem] bg-gray-200"/>
                      <div className="label">
                          <span className="label-text-alt"></span>
                      </div>
                  </label>
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Commune de naissance <span className="text-red-600">*</span></span>
                      </div>
                      <input
                          onChange={(e) => setCommonBirth(e.target.value)}
                          type="text" placeholder="Commune de naissance" className="input w-[22rem] bg-gray-200"/>
                      <div className="label">
                          <span className="label-text-alt"></span>
                      </div>
                  </label>
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Lieu de naissance <span className="text-red-600">*</span></span>
                      </div>
                      <input
                          onChange={(e) => setAdressBirth(e.target.value)}
                          type="text" placeholder="Lieu de naissance" className="input w-[22rem] bg-gray-200"/>
                      <div className="label">
                          <span className="label-text-alt"></span>
                      </div>
                  </label>
                ...
                <div className="flex items-center font-semibold mt-10">
                  ...
                  <input
                    ...
                    type="radio" name="gender" value={"Garçon"} className="radio border-color2 border-2 w-5 h-5"/>
                  <label htmlFor={"Fille"} className="mx-2">Fille</label>
                  <input
                    onChange={(e) => setGender(e.target.value)}
                    type="radio" name="gender" value={"Fille"} className="radio border-color2 border-2 w-5 h-5"/>
                </div>
                ...
                <div className="flex items-center font-semibold mt-10">
                    ...
                    type="radio" name="handicap" value={"Oui"} className="radio border-color2 border-2 w-5 h-5"/>
                    ...
                    type="radio" name="handicap" value={"Non"} className="radio border-color2 border-2 w-5 h-5"/>
                </div>
                <select
                    onChange={(e) => setWtHandicap(e.target.value)}
                    name="wthandicap" defaultValue={"0"} disabled={!isHandicapEnabled} className="select w-[22rem] bg-gray-200 ml-24 mt-10">
            ...
            <div className="bg-gray-50 p-5 rounded mt-20">
              ...
              <div className="flex flex-wrap justify-items-center">
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Adresse <span className="text-red-600">*</span></span>
                      </div>
                      <input
                  ...
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Département <span className="text-red-600">*</span></span>
                      </div>
                      <input
                  ...
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Commune <span className="text-red-600">*</span></span>
                      </div>
                      <input
                  ...
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Ville / Quartier <span className="text-red-600">*</span></span>
                      </div>
                      <input
            ...
            <div className="bg-gray-50 p-5 rounded mt-20">
              ...
              <div className="flex flex-wrap justify-items-center">
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Nom du Père <span className="text-red-600">*</span></span>
                      </div>
                      <input
                  ...
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Prénom du Père <span className="text-red-600">*</span></span>
                      </div>
                      <input
                  ...
                  <label className="form-control w-full max-w-xs mr-20 mb-10">
                      <div className="label">
                          <span className="label-text text-black">Profession <span className="text-red-600">*</span></span>
                      </div>
                      <input
                          onChange={(e) => setJobFather(e.target.value)}
                          type="text" placeholder="Profession du père" className="input w-[22rem] bg-gray-200"/>
                      <div className="label">
                          <span className="label-text-alt"></span>
                      </div>
                  </label>
                ...
                <div className="flex items-center font-semibold mb-10">
                  ...
                  <input
                    ...
                    type="radio" name="3" value={"Décédé"} className="radio border-color2 border-2 w-5 h-5"/>
                  <h2 className="mx-2">Vivant</h2>
                  <input
                    onChange={(e) => setStatutFather(e.target.value)}
                    type="radio" name="3" value={"Vivant"} className="radio border-color2 border-2 w-5 h-5 mr-[40rem]"/>
                </div>
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Nom de la Mère <span className="text-red-600">*</span></span>
                      </div>
                      <input
                  ...
                  <label className="form-control w-full max-w-xs mr-20 mb-2">
                      <div className="label">
                          <span className="label-text text-black">Prénom de la Mère <span className="text-red-600">*</span></span>
                      </div>
                      <input
                ...
                <div className="flex items-center font-semibold">
                  ...
                  <input
                    ...
                    type="checkbox" name="statutMother" value={"Décédée"} className="checkbox border-color2 border-2 w-5 h-5"/>
                  <h2 className="mx-2">Vivante</h2>
                  <input
                    onChange={(e) => setStatutMother(e.target.value)}
                    type="checkbox" name="4" value={"Vivante"} className="checkbox border-color2 border-2 w-5 h-5"/>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 p-5 rounded mt-20">
              ...
              <div className="flex flex-wrap justify-items-center">
                  <label className="form-control w-full max-w-xs mr-20 mb-10">
                      <div className="label">
                          <span className="label-text text-black">Lien de parenté et/ou nom complet <span className="text-red-600">*</span></span>
                      </div>
                      <input
                  ...
                  <label className="form-control w-full max-w-xs mr-20 mb-10">
                      <div className="label">
                          <span className="label-text text-black">Téléphone <span className="text-red-600">*</span> </span>
                      </div>
                      <input
                          onChange={(e) => setPhone(e.target.value)}
                          type="text" placeholder="Téléphone" className="input w-[22rem] bg-gray-200 mr-20 mb-10"/>
                      <div className="label">
                          <span className="label-text-alt"></span>
                      </div>
                  </label>
                  <label className="form-control w-full max-w-xs mr-20 mb-10">
                      <div className="label">
                          <span className="label-text text-black">Téléphone additionel</span>
                      </div>
                      <input
                          onChange={(e) => setOtherPhone(e.target.value)}
                          type="text" placeholder="Autre téléphone" className="input w-[22rem] bg-gray-200 mr-20 mb-10"/>
                      <div className="label">
                          <span className="label-text-alt"></span>
                      </div>
                  </label>
